...
import CBD4English from './cbd/cbd-4-english';
import CBD5English from './cbd/cbd-5-english';
    ...
    return new Promise((resolve) => {
      switch (sectionId) {
        case 'cbd-1-english':
          ...
          break;
        case 'cbd-2-english':
          resolve({ data: CBD2English({ userId }) });
          break;
        case 'cbd-3-english':
          resolve({ data: CBD3English({ userId }) });
          break;
        case 'cbd-4-english':
          resolve({ data: CBD4English({ userId }) });
          break;
        case 'cbd-5-english':
          resolve({ data: CBD5English({ userId }) });
          break;
        ...
        case 'muscle-2-english':
          resolve({ data: Muscle2English({ userId }) });
          break;
        case 'muscle-3-english':
          resolve({ data: Muscle3English({ userId }) });
          break;
        case 'muscle-4-english':
          resolve({ data: Muscle4English({ userId }) });
          break;
        ...
        case 'erectile-dysfunction-2-english':
          resolve({ data: ErectileDysfunction2English({ userId }) });
          break;
        case 'erectile-dysfunction-3-english':
          resolve({ data: ErectileDysfunction3English({ userId }) });
          break;
        case 'erectile-dysfunction-4-english':
          resolve({ data: ErectileDysfunction4English({ userId }) });
          break;
